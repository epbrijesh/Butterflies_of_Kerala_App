...
},
{
  ...
  description3: " കേരളത്തിലെ ഗ്രാമങ്ങളിലും കാട്ടുപാതയിലുമൊക്കെ ഇവയെ കാണാവുന്നതാണ്. ആണ്‍ പൂമ്പാറ്റകള്‍ വെയിലില്‍ പറന്ന് നടക്കാറുണ്ട്. എന്നാല്‍ പെണ്‍പൂമ്പാറ്റകള്‍ക്ക് തണലില്‍ കഴിയാനാണ് ഇഷ്ടപ്പെടുന്നത്. ഈര്‍പ്പം നിറഞ്ഞ അന്തരീക്ഷം ആണ് ഇവയ്ക്കു പ്രിയം. മിക്ക പുഴക്കരയിലെ മണലിലും ഇവയെ കണ്ടെത്താം. വളരെ വേഗത്തില്‍ സഞ്ചരിക്കുന്ന കൃഷ്ണശലഭങ്ങള്‍ താഴ്ന്ന് പറക്കുന്നത് അപൂര്‍വ്വമാണ്. നാരകം, കാട്ടുനാരകം എന്നിവയിലാണ് ഈ ശലഭങ്ങള്‍ മുട്ടയിടുന്നത്. തിളങ്ങുന്ന പച്ച നിറത്തിലാണ് ലാര്‍വ്വകള്‍ കാണപ്പെടുന്നത്.",
  description4: "",
  description5: "",
  wingspan: "120-150 mm", 
  hostPlants: [ 
...
},
{
  ...
  mainPhoto: "~/images/malabarbandedswallowtail1.jpg",
  photos: [
  { url: "~/images/malabarbandedswallowtail1.jpg", credit: "© Davidvraju, Wikimedia Commons", sourceUrl: "https://commons.wikimedia.org/wiki/File:Malabar_Banded_Swallowtail_David_Raju.jpg" },
  { url: "~/images/malabarbandedswallowtail2.jpg", credit: "© സുഭാഷ് പുളിക്കല്‍", sourceUrl: "https://commons.wikimedia.org/" }
  ],
...
},
{
  ...
  description3: " ചുവപ്പുശരീരവും പിന്‍ചിറകുകളില്‍ കാണപ്പെടുന്ന തിളങ്ങുന്ന ചുവന്ന പൊട്ടുകളും ഇവയെ എളുപ്പം തിരിച്ചറിയാന്‍ സഹായിക്കുന്നു. പിന്‍ചിറകുകളില്‍ പതിമൂന്ന് പൊട്ടുകളുള്ളതില്‍ പിന്‍നിരയിലുള്ളവ അര്‍ദ്ധചന്ദ്രാകൃതിയിലുള്ളവയാണ്. മുട്ടയ്ക്ക് തവിട്ടുകലര്‍ന്ന ഓറഞ്ച് നിറമാണ്. ശലഭപ്പുഴുവിന് ഇരുണ്ട കരിംചുവപ്പ് നിറവും ദേഹത്ത് മുള്ളുകള്‍ പോലെ തോന്നുന്ന അറ്റം കൂര്‍ത്ത മുഴകള്‍ ഉണ്ട്.",
  description4: " പുഴുപ്പൊതിക്ക് ഉണങ്ങിയ ഇലയുടെ നിറമാണ്.",
  description5: "",
    wingspan: "... mm", 
  hostPlants: [ 
    { name: "....", wikiLink: "https://en.wikipedia.org/" }, 
